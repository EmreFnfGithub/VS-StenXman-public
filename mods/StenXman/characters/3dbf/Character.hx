function create() {
    ...
    character.animation.addByPrefix('singUP', 'BF NOTE UP', 24, false);
    character.animation.addByPrefix('singLEFT', 'BF NOTE LEFT', 24, false);
    character.animation.addByPrefix('singRIGHT', 'BF NOTE RIGHT', 24, false);
    character.animation.addByPrefix('singDOWN', 'BF NOTE DOWN', 24, false);
